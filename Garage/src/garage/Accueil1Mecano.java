 ...
 */
public class Accueil1Mecano extends javax.swing.JFrame {

    /**
     * Creates new form Accueil1Mecano
     */
    public Accueil1Mecano() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" BIENVENUE QUE VOULER VOUS FAIRE?");

        jToggleButton1.setBackground(new java.awt.Color(204, 255, 255));
        jToggleButton1.setText("CONSULTER EMPLOI DE TEMPS ");
        ...
        jToggleButton2.setText("REDIGER UN RAPPORT");
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        try {
            ...
            AccueilMecano n = new AccueilMecano();
            
            n.setVisible(true);
            dispose();
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(Accueil1Mecano.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_jToggleButton1ActionPerformed

    private void jToggleButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton3ActionPerformed
        // TODO add your handling code here:
        LoginMecano n = new LoginMecano();
        n.setVisible(true);
        dispose();
    ...
    private void jToggleButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton2ActionPerformed
        // TODO add your handling code here:
        RapportMecano n = new RapportMecano();
        n.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Accueil1Mecano.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Accueil1Mecano().setVisible(true);
            }
        });
    }
